...
export class PostsComponent implements OnInit {
  ...
  constructor(
    ...
    private http: HttpClient, //pour les requetes (get, post, put, delete)
  ...
  toggleMyPostsFilter(): void {  //active/désactive le filtre pour afficher uniquement les posts de l'utilisateur connecté
...
// trait de la fonction vote
 ...
 //ouverture de la modale pour créer un post
  openPostModal(): void {
  ...
  createPost(): void {
    ...
    if (this.communityId) this.newPost.community.communityId = this.communityId;
    this.newPost.dateCreation = new Date();
    this.http.post('http://localhost:9090/posts', this.newPost).subscribe(
      (response) => {
