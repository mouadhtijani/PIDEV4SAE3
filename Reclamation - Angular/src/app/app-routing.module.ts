...
import { BackofficeReclamationsComponent } from './backoffice-reclamations/backoffice-reclamations.component';
...
const routes: Routes = [
  ...
  { path: 'backoffice/reclamations', component: BackofficeReclamationsComponent },
